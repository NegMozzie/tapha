...
namespace BlogBundle\Security\Authorization\Voter;


use BlogBundle\Entity\Article;
use BlogBundle\Security\ACL\ArticlePermissionMap;
        ...
        else
        {
            if(in_array('EDIT_ARTICLE', $attributes))
            {
                ...
                else
                {
                    ...
                    {
                        if($object instanceof Article && $object->getAuthor() == $user)
                        {
                            return self::ACCESS_GRANTED;
                        }
                        else
            ...
            elseif(in_array('EDIT_PUBLISH_STATUS', $attributes) && $object instanceof Article)
            {
